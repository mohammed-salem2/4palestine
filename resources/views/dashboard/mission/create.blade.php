...
@section('master')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('dashboard.mission.store') }}" method="post" enctype="multipart/form-data">
                    @csrf

                    @include('dashboard.mission._form_mission', [
                        'form_title' => 'Create Mission',
                    ])
    ...
    <script>
        var input = document.querySelector('input[name=tags]'),
            ...
            tagify = new Tagify(input, {
                whitelist: {!! json_encode($additionalData['tags']->toArray(), JSON_HEX_TAG) !!},
                dropdown: {
                    position: "manual",
                    maxItems: Infinity,
                    enabled: 0,
